<header class="primary-header">
  ...
  <nav class="primary-nav">
    <ul class="primary-nav__list">
      ...
      <li class="primary-nav__item <?php if ($page == 'crew') echo 'primary-nav__item--active' ?>">
        <a href="/crew-commander.php" class="primary-nav__link">
  ...
  <nav class="mobile-nav" id="js-mobile-nav">
    ...
    <ul clas="mobile-nav__list">
      ...
      <li>
        <a href="crew-commander.php" class="primary-nav__link"><span class="number">02</span> Crew</a>
      </li>
      <li>
